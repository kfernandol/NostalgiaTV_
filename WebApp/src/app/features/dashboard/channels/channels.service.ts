...
import { ChannelRequest, ChannelResponse, AssignSeriesRequest } from '../../../shared/models/channel.model';
...
export class ChannelsService {
    ...
    assignSeries(channelId: number, request: AssignSeriesRequest) {
        return this.http.put<ChannelResponse>(`${this.apiUrl}/${channelId}/series`, request, { withCredentials: true });
    }
}
